...
export class InfoScreen {
    ...
    draw_welcome() {
        ...
        if (this.parent.user_id) {
            this.info_canvas.ctx.fillText("Welcome to", this.width / 3, this.height * 0.42);
        } else {
            this.info_canvas.ctx.fillText("Welcome to the", this.width / 3.6, this.height * 0.42);
        }
        font_height = this.width / 12.5;
        this.info_canvas.ctx.font = "bold ".concat(font_height.toString(), "px Helvetica");
        if (this.parent.user_id) {
            this.info_canvas.ctx.fillText("Keyboard B!", this.width / 3.8, this.height * 0.6);
        } else {
            this.info_canvas.ctx.fillText("Row Column Scanner!", this.width / 13, this.height * 0.6);
        }
        ...
        this.info_canvas.ctx.fillStyle = "#404040";
        this.info_canvas.ctx.font = "".concat(font_height.toString(), "px Helvetica");
        this.info_canvas.ctx.fillText("(1) Locate the box containing the letter or word you want to type.",
    ...
    draw_text_info() {
        this.info_canvas.ctx.clearRect(0, this.height * 0.8, this.width, this.height);
    ...
    draw_scan_delay_info() {
        ...
        this.info_canvas.ctx.fillText("scan speed.", this.width / 20, this.height / 15 + 2.3 * font_height);
    }

    draw_extra_delay_info() {
        var font_height = this.width / 70;

        this.info_canvas.ctx.fillStyle = "#ffffff";
        this.info_canvas.ctx.strokeStyle = "#404040";
        this.info_canvas.ctx.lineWidth = font_height * 0.3;
        roundRect(this.info_canvas.ctx, this.width * 0.35, this.height / 15, font_height * 18, font_height * 3,
            20, true, true);

        var arrow_x_start = this.width * 0.4 + font_height * 16;
        var arrow_y_start = this.height / 15 + font_height * 1.5;
        ...
        this.info_canvas.ctx.fillStyle = "#404040";
        this.info_canvas.ctx.font = "".concat(font_height.toString(), "px Helvetica");
        this.info_canvas.ctx.fillText("This slider controls the scan", this.width * 0.36, this.height / 15 + 1.3 * font_height);
        this.info_canvas.ctx.fillText("speed of the first row and column.", this.width * 0.36, this.height / 15 + 2.3 * font_height);
    }
    ...
    draw_checkbox_info() {
        ...
        var arrow_x_start = rect_x + font_height * 27;
        ...
        this.info_canvas.ctx.fillText("Sound: A bell will sound when you press.",
            rect_x + font_height, rect_y + font_height * 2);
    }
