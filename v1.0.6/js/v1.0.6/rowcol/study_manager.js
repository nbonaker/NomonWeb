...
export class studyManager {
    ...
    init_session() {
        ...
        if (response) {
            ...
            this.parent.session_button.style.display = "none";

            this.parent.tutorial_button.onclick = null;
            this.parent.tutorial_button.style.display = "none";

            this.parent.change_user_button.onclick = null;
            ...
            session_counter_text = session_counter_text.concat("session with the RCS.");
