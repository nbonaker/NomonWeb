...
import * as mouse_loc from "../mouse_locator.js";
...
class Keyboard {
    constructor(user_id, first_load, phase, prev_data) {
        ...
        this.mouse_loc = new mouse_loc.MouseLocator(this, this.keygrid_canvas);
    ...
    animate() {
        if (this.full_init) {
            ...
            if (this.in_session) {
                ...
                var target_indices = widgets.indexOf_2d(kconfig.comm_target_layout, this.cur_emoji_target.toString());
                var target_clock = this.clockgrid.clocks[target_indices[0] * this.clockgrid.target_layout[0].length + target_indices[1]];
                this.mouse_loc.save_mouse_loc(time_in, target_clock);
            }
        }
