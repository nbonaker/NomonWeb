            ...
            <div id="inner">
                ...
                <table class="table table-striped" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">
                            03:31 * (1.25 to offset setup times) = 04:23
                        </td>
                    </tr>
                    <tr>
                        <th>
    ...
    <tr>
        <td colspan="2">
            <img id="click_analy_error"
                 src="figures/<?php echo $user_id ?>/click_analysis_vs_final_error.svg#svgView(viewBox(200, 0, 1960, 2160))"
                 width="100%"/>
            <img id="click_analy_cload"
                 src="figures/<?php echo $user_id ?>/click_analysis_vs_click_load.svg#svgView(viewBox(200, 0, 1960, 2160))"
