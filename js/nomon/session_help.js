...
export class helpManager {
    ...
    draw_welcome() {
        ...
        if (this.text_num >= 0) {
            ...
            this.info_canvas.ctx.fillText("Great! Let's get started with a practice phrase.",
            ...
            this.info_canvas.ctx.fillText("getting you used to the interface.",
    ...
    draw_info_1() {
        ...
        if (this.text_num >= 0) {
            ...
            this.info_canvas.ctx.fillStyle = "#404040";
            this.info_canvas.ctx.font = "".concat(this.font_height.toString(), "px Helvetica");
            this.info_canvas.ctx.fillText("You'll see a phrase like this one ",
                rect_x + this.font_height, rect_y + this.font_height * 1.3);
        ...
        if (this.text_num >= 1) {
            ...
            this.info_canvas.ctx.fillText("I'll keep track of where you are in the phrase for you.",
                rect_x + this.font_height, rect_y + this.font_height * 1.3);
            this.info_canvas.ctx.fillText("I'll highlight the item you need to select next in pink ",
                rect_x + this.font_height, rect_y + this.font_height * 2.7);
